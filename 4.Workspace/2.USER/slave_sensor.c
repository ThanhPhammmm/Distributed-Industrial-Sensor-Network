    ...
    for (i = 0; i < k_cnt; i++) {
        ...
        case DTYPE_FLOAT:
            switch ((eSensorType)s->sensorType) {
							case SENSOR_TEMPERATURE: s->reading.f = 25.5f; break;
							case SENSOR_HUMIDITY:    s->reading.f = 62.0f; break;
							default:                 s->reading.f = 8.8f;  break;
            }
            break;
        case DTYPE_DOUBLE:
        ...
        case DTYPE_INT32:
            switch ((eSensorType)s->sensorType) {
							case SENSOR_ADC_RAW:    s->reading.i = 2048; break;
							case SENSOR_DIGITAL_IN: s->reading.i = 1;    break;
							default:                s->reading.i = 999;    break;
            }
            break;
        }
    }
