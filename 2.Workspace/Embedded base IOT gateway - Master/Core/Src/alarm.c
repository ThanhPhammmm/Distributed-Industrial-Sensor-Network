...
static const AlarmRule_t k_rules[] = {
	// Sensor 1: DIGITAL_IN, FLOAT
	{
		.slaveAddr = 0x01,
		.sensorId = 1,
		.sensorType = SENSOR_DIGITAL_IN,
	...
	// Sensor 2: ADC_RAW, INT32
	{
		.slaveAddr = 0x01,
		.sensorId = 2,
		.sensorType = SENSOR_ADC_RAW,
